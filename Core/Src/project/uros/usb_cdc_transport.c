...
size_t Uros_UsbCdcTransport_Write(struct uxrCustomTransport *transport, uint8_t *buf, size_t len, uint8_t *err) {
...
size_t Uros_UsbCdcTransport_Read(struct uxrCustomTransport *transport, uint8_t *buf, size_t len, int timeout, uint8_t *err) {
