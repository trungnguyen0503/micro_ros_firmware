...
#define Actuator_Motor_LEFT_FORWARD_CHANNEL TIM_CHANNEL_1
#define Actuator_Motor_LEFT_BACKWARD_CHANNEL TIM_CHANNEL_2
#define Actuator_Motor_RIGHT_FORWARD_CHANNEL TIM_CHANNEL_3
#define Actuator_Motor_RIGHT_BACKWARD_CHANNEL TIM_CHANNEL_4

#define Actuator_Motor_MIN_RPM 10.0
#define Actuator_Motor_MAX_RPM 125.0
